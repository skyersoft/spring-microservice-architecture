...
@RestController
@RequestMapping("/api/fxdata-kafka")
public class FxdataKafkaResource {

    private final Logger log = LoggerFactory.getLogger(FxdataKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public FxdataKafkaResource(KafkaProperties kafkaProperties) {
